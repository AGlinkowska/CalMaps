...
public class MySQLite extends SQLiteOpenHelper {
    ...
    public void dodaj(Wydarzenie wydarzenie){
        ...
        Cursor cursor =
                db.query("wydarzenia",
                        new String[] { "_id",
                                "summary", "location", "startDate", "comment" },

                        "summary = ? and location = ? and startDate = ? and comment = ?",
                        new String[] {
                                wydarzenie.getSummary(), wydarzenie.getLocation(), wydarzenie.getStartDate(), wydarzenie.getComment() },
                        null,
                        null,
                        null,
                        null);
        if(cursor.getCount() <= 0) {
            ...
            values.put("comment", wydarzenie.getComment());
